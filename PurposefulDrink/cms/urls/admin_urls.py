...
from ..views.admin_views import HerbViewSet, DiseaseViewSet, AgeRangeViewSet, SuitabilityViewSet, SeasonalScoreViewSet, JobScoreViewSet, JobPollutionLevelScoreViewSet
