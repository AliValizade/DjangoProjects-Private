...
from .views import HerbViewSet, DiseaseViewSet, AgeRangeViewSet, SuitabilityViewSet, PostViewSet, CommentViewSet, VoteViewSet, SeasonalScoreViewSet, JobScoreViewSet, JobPollutionLevelScoreViewSet
